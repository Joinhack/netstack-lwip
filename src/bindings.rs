...
extern "C" {
    pub fn fgetln(arg1: *mut FILE, __len: *mut size_t) -> *mut ::std::os::raw::c_char;
}
extern "C" {
    pub fn fmtcheck(
        arg1: *const ::std::os::raw::c_char,
...
extern "C" {
    pub fn mbstowcs(arg1: *mut wchar_t, arg2: *const ::std::os::raw::c_char, __n: size_t)
        -> size_t;
}
extern "C" {
    pub fn mbtowc(
...
extern "C" {
    pub fn wcstombs(arg1: *mut ::std::os::raw::c_char, arg2: *const wchar_t, __n: size_t)
        -> size_t;
}
extern "C" {
...
extern "C" {
    pub fn getcwd(arg1: *mut ::std::os::raw::c_char, __size: size_t)
        -> *mut ::std::os::raw::c_char;
}
extern "C" {
...
pub type icmp_recv_fn = ::std::option::Option<
    unsafe extern "C" fn(
        arg: *mut ::std::os::raw::c_void,
        pcb: *mut icmp_pcb,
        p: *mut pbuf,
...
>;
extern "C" {
    pub fn set_icmp_ping_pcb(recv: icmp_recv_fn, recv_args: *mut ::std::os::raw::c_void);
}
extern "C" {
    pub fn icmp_sendto(pbuf: *mut pbuf, src: *const ip_addr_t, dest: *const ip_addr_t) -> err_t;
}
extern "C" {
